		...
		<div class="ten columns alpha">
			...
			<?php if(ot_get_option('show_faculty_sidebar_name') != "off" ) : ?>
				<div class="faculty-name">
					<h2><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php the_author_meta('display_name'); ?></a></h2>
				</div>
			<?php endif; ?>
		...
		<div class="faculty-section sixteen columns alpha omega">
			...
			<?php if(ot_get_option('show_faculty_sidebar_nav') != "off" ) : ?>
				<div class="faculty-classes">
					<h5><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php _e( 'Back to', 'mythology' ); ?> <?php the_author_meta('display_name'); ?>'s <?php _e( 'Courses', 'mythology' ); ?></a></h5>
				</div>
			<?php endif; ?>
