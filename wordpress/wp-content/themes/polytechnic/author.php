		...
		<main id="main" class="site-main" role="main">
			...
			<div class="page-content clearfix">
					...
					<?php if(ot_get_option('show_faculty_name') != "off" ) : ?>
						<div class="author-meta eight columns meta-item">
							<div class="faculty-name">
								...
								<span><?php echo esc_html( $curauth->display_name ); ?></span></h5>
							</div>
						</div>
					<?php endif; ?>
					...
					<?php if(ot_get_option('show_faculty_email') != "off" ) : ?>
						<div class="author-meta eight columns meta-item">
							<div class="faculty-email">
								...
								<span><?php echo esc_html( $curauth->user_email ); ?></span></h5>
							</div>
						</div>
					<?php endif; ?>
				...
				<?php if(ot_get_option('show_faculty_course_list') != "off" ) : ?>
					...
					<p>Click each course for class syllabus, materials, course information, updates, and upcoming tests. </p>
